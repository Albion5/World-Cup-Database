...
CREATE TABLE public.games (
    game_id integer NOT NULL, year integer NOT NULL, round character varying(50) NOT NULL, winner_id integer NOT NULL, opponent_id integer NOT NULL, winner_goals integer NOT NULL, opponent_goals integer NOT NULL
);
...
CREATE TABLE public.teams (
    team_id integer NOT NULL, name character varying(50) NOT NULL
);
